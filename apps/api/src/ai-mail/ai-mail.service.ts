...
- חובה: השתמש בדיוק בשם הלקוח, שם איש הקשר ושם השירות שנמסרו לך — אל תחליף אותם בשמות אחרים ואל תמציא שירות אחר. אם שם שירות לא נמסר, אל תנחש סוג בדיקה ספציפי.
