...
2. משפט קבוע מיד אחרי הפנייה (פסקה נפרדת): "מצורפים גם תעודות ההסמכה ופרופיל החברה שלנו לעיונכם." — כתוב אותו בדיוק כך, תמיד, כשורה הראשונה בגוף המייל לפני כל תוכן אחר.
3. משפט פתיחה: "מצורפת הצעת מחיר מס' [מספר] עבור [תיאור קצר של העבודה במיקום]."
...
כללים מחייבים:
- משפט תעודות ההסמכה ופרופיל החברה (סעיף 2) חייב להופיע תמיד כפסקה הראשונה בגוף, מיד אחרי הפנייה, בנוסח המדויק שנמסר.
