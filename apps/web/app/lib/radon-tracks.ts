 ...
 *
 * `Task.productName` מכיל לרוב קוד SKU ("61"/"10000"), אבל חלק מהמשימות נשמרות
 * עם *שם* השירות בעברית ("ראדון – ערכה לבדיקת גז ראדון ארוכת טווח") — ואז בדיקת
 * הקוד בלבד נכשלה וכפתור התזכורת פשוט לא הופיע. לכן מזהים גם לפי השם.
 */
